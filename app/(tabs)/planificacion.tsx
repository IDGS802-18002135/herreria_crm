...
const CalcularTiempoProduccion = () => {
  ...
  useEffect(() => {
    const fetchProductos = async () => {
      try {
        const response = await fetch('http://192.168.57.70:5055/api/productos');
  ...
  const handleCalcularTiempo = async () => {
    ...
    try {
      const response = await fetch('http://192.168.57.70:5055/api/planificacion/calcularTiempoProduccion', {
        method: 'POST',
        headers: {
  ...
  const handleMandarAProduccion = async () => {
    ...
    try {
      const produccionResponse = await fetch('http://192.168.57.70:5055/api/produccion/solicitarProduccion', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
